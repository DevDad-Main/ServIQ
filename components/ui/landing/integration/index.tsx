      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1">
          ...
          <p className="text-lg text-zinc-400 font-light mb-8 leading-relaxed">
            No complex SDKs or user syncing required. Just add our script tag
            and you&apos;re ready to go. we inherit your CSS variables
            automatically.
          </p>
        ...
        <div className="flex-1 w-full max-w-lg">
          <div className="glass-card rounded-xl p-6 relative">
            ...
            <div className="font-mono text-xs md:text-sm leading-7 text-zinc-400">
              <div className="text-zinc-600">&lt;!-- ServIQ Support --&gt;</div>
              <div>
              ...
              <div className="pl-4">
                ...
                <span className="text-emerald-400">
                  &quot;https://serviqsupport.com/init.js&quot;
                </span>
              </div>
              ...
              <div className="pl-4">
                ...
                <span className="text-emerald-400">
                  &quot;b34jsf-ja442c-b244h6-34js-342asdj&quot;
                </span>
                <br />
