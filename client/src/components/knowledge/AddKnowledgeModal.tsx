        ...
        >
          <div className="px-6 border-b border-white/5">
            <TabsList className="bg-transparent h-auto p-0 gap-6">
              <TabsTrigger
                value="website"
                className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-indigo-500 rounded-none px-0 py-3 text-xs uppercase tracking-wider text-zinc-500 data-[state=active]:text-white transition-all focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none focus:outline-non ring-0 outline-none border-t-0 border-x-0"
              >
                Website
              </TabsTrigger>
          ...
          <div className="p-6 min-h-50 space-y-4">
              ...
              <div className="p-4 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-200 text-sm flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-indigo-300/80 mt-1 leading-relaxed">
                    Enter a website URL to crawl or add a specific page link to
            ...
            <TabsContent
              ...
              className="mt-0 space-y-4 animate-in fade-in duration-300"
            >
              <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-200 text-xs flex gap-3">
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  className="bg-white/5 border-white/10 h-32 resize-non"
                  value={docsContent}
            ...
            >
              ...
              />
              <div
                className="border-2 border-dashed border-white/10 rounded-xl h-60 flex flex-col items-center justify-center text-center cursor-pointer"
                onClick={() => {
